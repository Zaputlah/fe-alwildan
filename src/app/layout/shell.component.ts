  ...
  template: `
    <div class="app-shell" [class.sidebar-open]="menuOpen()">
      <aside class="sidebar">
        ...
        <div class="sidebar-help"><span>Butuh bantuan?</span><strong>Dokumentasi sistem</strong><small>Versi prototype 1.0</small></div>
      </aside>
      <section class="workspace">
        <header class="topbar">
          ...
          <div class="account">
            ...
            <div class="account-copy"><strong>{{ auth.user()?.fullName }}</strong><small>{{ auth.user()?.role === 'ADMIN' ? 'Administrator' : 'Guru' }}</small></div>
